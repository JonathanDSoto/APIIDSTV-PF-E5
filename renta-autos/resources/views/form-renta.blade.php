            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="py-3 mb-4"><span class="text-muted fw-light"></span> Agregar Renta</h4>
                                ...
                                <form class="card-body" id="form-renta">
                                    ...
                                    <div class="row mb-3">
                                        <label class="col-sm-3 col-form-label text-sm-end" for="renta-nombre">Nombre del
                                            Cliente</label>
                                        <div class="col-sm-9">
                                            <input type="text" id="renta-nombre" class="form-control"
                                                placeholder="Nombre del Cliente" />
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <label class="col-sm-3 col-form-label text-sm-end"
                                            for="renta-vehiculo">Vehículo</label>
                                        <div class="col-sm-9">
                                            <input type="text" id="renta-vehiculo" class="form-control"
                                                placeholder="Vehículo" />
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <label class="col-sm-3 col-form-label text-sm-end"
                                            for="renta-fecha-inicio">Fecha de Inicio</label>
                                        <div class="col-sm-9">
                                    ...
                                    <div class="row mb-3">
                                        <label class="col-sm-3 col-form-label text-sm-end"
                                            for="renta-deposito">Depósito</label>
                                        <div class="col-sm-9">
                                            <input type="number" id="renta-deposito" class="form-control"
                                                placeholder="Depósito" />
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <label class="col-sm-3 col-form-label text-sm-end"
                                            for="renta-telefono">Teléfono</label>
                                        <div class="col-sm-9">
                                            <input type="tel" id="renta-telefono" class="form-control"
                                                placeholder="Teléfono" />
                                        </div>
                                    </div>
                                    <div class="row pt-4">
                                        <div class="col-sm-9 offset-sm-3">
                                            <button type="button" class="btn btn-success me-sm-2 me-1"
                                                onclick="agregarRenta()">Agregar Renta</button>
