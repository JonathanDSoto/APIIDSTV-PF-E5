            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="py-3 mb-4"><span class="text-muted fw-light"></span> Agregar Vehículo</h4>
                            ...
                            <div class="card mb-4">
                                <form class="card-body">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" id="vehiculo-placa" class="form-control"
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" id="vehiculo-modelo" class="form-control"
                                        ...
                                        <div class="col-sm-9">
                                            <div class="form-check form-switch">
                                                ...
                                                <label class="form-check-label"
                                                    for="vehiculo-estado-disponible">Disponible</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row pt-4">
                                        <div class="col-sm-9 offset-sm-3">
                                            <button type="submit" class="btn btn-success me-sm-2 me-1">Agregar
                                                Vehículo</button>
