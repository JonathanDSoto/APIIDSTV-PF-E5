                                ...
                                <form class="card-body">
                                    ...
                                    <div class="row mb-3">
                                        <label class="col-sm-3 col-form-label text-sm-end"
                                            for="cliente-nombre">Nombre</label>
                                        <div class="col-sm-9">
                                    ...
                                    <div class="row mb-3">
                                        <label class="col-sm-3 col-form-label text-sm-end"
                                            for="cliente-telefono">Teléfono</label>
                                        <div class="col-sm-9">
                                    ...
                                    <div class="row mb-3">
                                        <label class="col-sm-3 col-form-label text-sm-end"
                                            for="cliente-direccion">Dirección</label>
                                        <div class="col-sm-9">
                                            <textarea id="cliente-direccion" class="form-control"
