...
<body>
    ...
    <div class="layout-wrapper layout-content-navbar  ">
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="py-3 mb-4"><span class="text-muted fw-light"></span> Agregar Categoria</h4>
                        <div class="col-xxl">
                            <div class="card mb-4">
                                <form class="card-body">
                                    <h6>Agregar Cartegoria</h6>
                                    <div class="row mb-3">
                                        <label class="col-sm-3 col-form-label text-sm-end" for="categoria-nombre">Nombre
                                            de
                                            la Categoria</label>
                                        <div class="col-sm-9">
                                            <input type="text" id="categoria-nombre" class="form-control"
                                                placeholder="Nombre de la Categoria" />
                                        </div>
                                    </div>
                                    <div class="row pt-4">
                                        <div class="col-sm-9 offset-sm-3">
                                            <button type="submit" class="btn btn-success me-sm-2 me-1">Agregar</button>
        ...
        <!-- Modal -->
<div class="modal fade" id="agregarClienteModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <!-- Tu formulario va aquí (copia y pega el formulario que ya tienes) -->
            </div>
